...
namespace SchoolApplication.Context
{
    ...
    public class SchoolApplicationDesignTimeDbContextFactory : IDesignTimeDbContextFactory<SchoolApplicationContext>
    {
        ...
        /// 3) dotnet ef migrations add [name] --project SchoolApplication.Context\SchoolApplication.Context.csproj
        /// 4) dotnet ef database update --project SchoolApplication.Context\SchoolApplication.Context.csproj
        ...
        {
            var connectionString = "Host=localhost;Port=5432;Database=grid;Username=postgres;Password=123";
